    ...
    private void RunConversation(string userName) {
        ...
        while (chatting) {
            ...
            if (lowerInput == "exit" || lowerInput == "quit" || lowerInput == "bye") {
                ...
                PrintBotResponse("Social engineering is when attackers manipulate people into revealing confidential info. Always verify who you are speaking to before sharing any personal details.");
            }
